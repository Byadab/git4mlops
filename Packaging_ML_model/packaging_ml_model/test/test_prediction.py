...
# output from predict script ot null
# output from predict script is str dtype
# the output is Y for an example data

#fixtures: Are basically the function that run before execution of the test_function
#--->ensure single_predcition run before executing suchg text function
